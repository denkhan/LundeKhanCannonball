...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    //public int[] AcquireScreenSize(){
      //  DisplayMetrics displayMetrics = new DisplayMetrics();
        //WindowManager windowmanager = (WindowManager) getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
        //windowmanager.getDefaultDisplay().getMetrics(displayMetrics);
        //int[] toreturn = new int[2];
        //toreturn[0] = displayMetrics.widthPixels;
        //toreturn [1] = displayMetrics.heightPixels;
        //return toreturn;
    //}
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        bg = new Background(BitmapFactory.decodeResource(getResources(), R.drawable.blackscreen2));
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.circle3), 50 , 50, 1);
...

    {
        if(player.getPlaying()) {
           ...
           // this.updateTopBorder();
            ...
            //add missiles on timer Försöker byta ut missiler mot hinder
           ...
           if(obstacleElapsed > 5000){
               obstacles.add(new Obstacle(BitmapFactory.decodeResource(getResources(),R.drawable.halfobstaclewhite),
                 WIDTH,0,100,300, player.getScore(), 1));
            ...
            for(int i = 0; i<obstacles.size();i++){
               ...
               // remove obstacle if it's way off the screen
                if(obstacles.get(i).getX() <- 100){
                    obstacles.remove(i);
                    break;
                }
            }
            //Försöker få bort detta
    ...
    public void draw(Canvas canvas)
    {
      ...
      // testar remova top border update i update
